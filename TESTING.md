...
| I9 | Migration from <=1.2.0 | On an install with `plugins/openlitespeed_reload/config/allowed_resellers` populated, install 1.3.0 over it | Installer prints `migrated allowed_resellers ...`; entries appear at the new path and remain authorized |
